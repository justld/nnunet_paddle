...
class MultipleLoss(nn.Layer):
    def __init__(self, losses, coef, ignore_index=255, plan_path=None, stage=None):
    ...
    def forward(self, logits, labels):
        assert isinstance(logits, (tuple, list)), "x must be either tuple or list"
        assert isinstance(labels, (tuple, list)), "y must be either tuple or list"
